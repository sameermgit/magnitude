   ...
   for(i = 0; i < 2; i++)             //getting input from user for second vector
    ...
    for (i = 0; i < 2; i++)
      ...
      c1=a1*b1;                         //finding the denominator
       ...
       /* APPLICATION
      - it is used to find the angle between the two lines.
      - it is used to find distance travelled by the object.
      - it is used to find at which the direction is travelling.
      - it is also used in calculating at which direction the rocket is travelling.*/
